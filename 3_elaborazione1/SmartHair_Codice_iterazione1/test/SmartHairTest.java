...
public class SmartHairTest {
    ...
    @Test
    void testSelezionaServizioConCreditoSufficiente() {
        sm.accesso("mario.rossi@email.com", "password123");
        sm.ricaricaTessera(100.0);
        Map<String, Map<String, List<String>>> orari = sm.selezionaServizio("taglio");
        assertNotNull(orari);
        assertFalse(orari.isEmpty(), "La mappa degli orari non deve essere vuota");
    }

    @Test
    void testSelezionaServizioConCreditoInsufficiente() {
        sm.accesso("mario.rossi@email.com", "password123");
        Map<String, Map<String, List<String>>> orari = sm.selezionaServizio("colore");
        assertNull(orari, "Servizio non deve essere disponibile se credito insufficiente");
    }
