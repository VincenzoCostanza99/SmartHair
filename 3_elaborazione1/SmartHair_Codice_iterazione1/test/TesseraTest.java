...
public class TesseraTest {
    ...
    @Test
    void testSetterAccettaNegativi() {
        tessera.setCredito(-10.0);
        assertEquals(-10.0, tessera.getCredito(),
                "Il metodo setCredito deve aggiornare anche valori negativi se non sono controllati internamente.");
    }
